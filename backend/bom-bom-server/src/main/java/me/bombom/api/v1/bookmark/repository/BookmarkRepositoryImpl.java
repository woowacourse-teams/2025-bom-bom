...
import me.bombom.api.v1.bookmark.dto.QBookmarkResponse;
...
public class BookmarkRepositoryImpl implements CustomBookmarkRepository {
    ...
    @Override
    public Page<BookmarkResponse> findByMemberId(final Long memberId, final Pageable pageable) {
        JPAQuery<Long> totalQuery = getTotalQuery(memberId);
        List<BookmarkResponse> content = getContent(memberId, pageable);
    ...
    private List<BookmarkResponse> getContent(Long memberId, Pageable pageable) {

...
const banner1 = '/assets/image/banner_1.png';
const banner2 = '/assets/image/banner_2.png';
const banner3 = '/assets/image/banner_3.png';
const banner4 = '/assets/image/banner_4.png';
